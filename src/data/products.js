const products = [
  ...
  { id: 3, name: 'Pixel 9 Pro', price: 999, category: 'Phones & Tablets', image: '/products/pixel-9-pro.jpg', description: 'Google\'s flagship with pure Android and advanced AI.' },
  { id: 31, name: 'Samsung Galaxy S26 Ultra', price: 1399, category: 'Phones & Tablets', image: '/products/galaxy-s26-ultra.jpg', description: '200MP camera, Snapdragon 8 Elite, titanium frame.' },
  { id: 32, name: 'OnePlus 14 Pro', price: 899, category: 'Phones & Tablets', image: '/products/oneplus-14-pro.jpg', description: '120W fast charging, Hasselblad camera tuning.' },
  ...
  // Computing
  { id: 8, name: 'Gaming Laptop RTX 5090', price: 2499, category: 'Computing', image: '/products/gaming-laptop.jpg', description: 'Intel i9, 64GB RAM, RTX 5090 GPU, 240Hz display.' },
  { id: 9, name: 'UltraBook Pro 16"', price: 1599, category: 'Computing', image: '/products/ultrabook-pro.jpg', description: 'Lightweight, 20-hour battery, OLED display.' },
  { id: 10, name: 'Wireless Mechanical Keyboard', price: 149, category: 'Computing', image: '/products/mechanical-keyboard.jpg', description: 'RGB backlit, hot-swappable switches.' },
  { id: 35, name: '27" 4K Monitor IPS', price: 599, category: 'Computing', image: '/products/4k-monitor.jpg', description: '100% sRGB, HDR10, USB-C power delivery.' },
  { id: 36, name: 'External SSD 2TB', price: 189, category: 'Computing', image: '/products/external-ssd.jpg', description: 'NVMe speeds up to 2000MB/s, rugged design.' },
  ...
  { id: 37, name: 'Luxury Watch Automatic', price: 799, category: 'Fashion', image: '/products/luxury-watch.jpg', description: 'Swiss movement, sapphire crystal, leather strap.' },
  ...
  { id: 14, name: 'Vitamin C Serum 30ml', price: 39, category: 'Health & Beauty', image: '/products/vitamin-c-serum.jpg', description: 'Brightening and anti-aging formula.' },
  { id: 39, name: 'Hair Dryer Ionic Pro', price: 129, category: 'Health & Beauty', image: '/products/hair-dryer.jpg', description: 'Fast drying, frizz control, multiple heat settings.' },
  { id: 40, name: 'Massage Gun Deep Tissue', price: 199, category: 'Health & Beauty', image: '/products/massage-gun.jpg', description: '6 heads, 30 speed levels, quiet operation.' },

  // TVs & Audio
  { id: 15, name: '4K Smart TV 65"', price: 799, category: 'TVs & Audio', image: '/products/smart-tv-65.jpg', description: 'OLED display, built-in streaming apps.' },
  ...
  // Home & Office
  { id: 17, name: 'Robot Vacuum Cleaner', price: 399, category: 'Home & Office', image: '/products/robot-vacuum.jpg', description: 'LiDAR navigation, auto-empty station.' },
  { id: 18, name: 'Ergonomic Office Chair', price: 279, category: 'Home & Office', image: '/products/office-chair.jpg', description: 'Mesh back, lumbar support.' },
  { id: 28, name: 'LED Desk Lamp', price: 59, category: 'Home & Office', image: '/products/desk-lamp.jpg', description: 'Eye-caring, wireless charging base.' },
  ...
  { id: 22, name: 'Fitness Smartwatch', price: 299, category: 'Health & Beauty', image: '/products/smartwatch.jpg', description: 'ECG, blood oxygen, GPS.' },
  { id: 23, name: 'Portable Power Bank 50000mAh', price: 79, category: 'Phones & Tablets', image: '/products/power-bank.jpg', description: 'Fast charging, multiple ports.' },
  { id: 24, name: 'Drone with 4K Camera', price: 699, category: 'Computing', image: '/products/drone-4k.jpg', description: '60-min flight time, obstacle avoidance.' },
  ...
  { id: 27, name: 'Yoga Mat Premium', price: 49, category: 'Health & Beauty', image: '/products/yoga-mat.jpg', description: 'Non-slip, extra thick 8mm.' },
  ...
  { id: 30, name: 'Wireless Mouse Ergonomic', price: 39, category: 'Computing', image: '/products/wireless-mouse.jpg', description: 'Silent clicks, rechargeable.' },
  ...
  { id: 45, name: 'Smart Doorbell Camera', price: 199, category: 'Home & Office', image: '/products/doorbell-camera.jpg', description: '1080p HD, night vision, two-way audio.' },
  { id: 46, name: 'Air Purifier HEPA', price: 249, category: 'Home & Office', image: '/products/air-purifier.jpg', description: 'Covers 500 sq ft, smart sensor, quiet mode.' },
  { id: 47, name: 'Electric Bike 2026', price: 1499, category: 'Unique Gadgets', image: '/products/electric-bike.jpg', description: '750W motor, 80km range, full suspension.' },
